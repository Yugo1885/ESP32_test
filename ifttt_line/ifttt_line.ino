...
void loop(){
  ...
  TEMP = "Temperature:"+String((int)temp)+"oC";
  HUM = "Humidity:"+String((int)hum)+"%";
  Serial.println(TEMP);
  Serial.println(HUM);
  ...
  //xxx-xxxx-xxx為你的金鑰
  String getStr_line = "POST/trigger/Line_msg/with/key/XXX-XXXX-XXX?value1="TEMP"&value2="HUM" HTTP/1.1\r\n"+ "Host: " + host + "\r\n";
